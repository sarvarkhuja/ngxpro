    ...
    <div class="space-y-2 max-w-md">
      <div ngxproCell="m">
        ...
        <div ngxproTitle>
          ...
          <div ngxproSubtitle>Senior Developer</div>
        </div>
      </div>
      ...
      <div ngxproCell="m">
        ...
        <div ngxproTitle>
          ...
          <div ngxproSubtitle>UX Designer</div>
        </div>
      </div>
    </div>
  `
...
@Component({
  ...
  template: `
    <nav class="w-64 bg-white dark:bg-gray-900 rounded-lg shadow-sm">
      <button ngxproCell="m" class="w-full">
        <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
        </svg>
        <div ngxproTitle>
          <div class="font-medium">Dashboard</div>
          <div ngxproSubtitle>Overview and stats</div>
        </div>
      </button>
      ...
      <button ngxproCell="m" class="w-full">
        ...
        <div ngxproTitle>
          ...
          <div ngxproSubtitle>View reports</div>
        </div>
      </button>
      ...
      <button ngxproCell="m" class="w-full">
        ...
        <div ngxproTitle>
          ...
          <div ngxproSubtitle>Configure app</div>
        </div>
      </button>
    </nav>
  `
      ...
      @for (item of items; track item.id) {
        <div ngxproCell="l">
          ...
          <div ngxproCellActions>
            ...
            <button
              class="p-2 rounded-lg hover:bg-red-100 dark:hover:bg-red-900 text-red-600 transition-colors"
              aria-label="Delete"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  template: `
    <div class="space-y-4 max-w-md">
      <div>
        ...
        <div ngxproCell="m" [height]="'compact'" class="border border-gray-200 dark:border-gray-800">
          <div ngxproTitle>
            <div>Compact Cell</div>
            <div ngxproSubtitle>No vertical padding</div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div ngxproCell="m" class="border border-gray-200 dark:border-gray-800">
          <div ngxproTitle>
            <div>Normal Cell</div>
            <div ngxproSubtitle>Standard padding</div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div ngxproCell="m" [height]="'spacious'" class="border border-gray-200 dark:border-gray-800">
          <div ngxproTitle>
            <div>Spacious Cell</div>
            <div ngxproSubtitle>Extra vertical padding</div>
          </div>
        </div>
      </div>
    </div>
...
@Component({
  ...
  template: `
    <div class="space-y-2 max-w-md">
      <div ngxproCell="s" class="border border-gray-200 dark:border-gray-800">
        <div class="w-6 h-6 rounded bg-green-100 dark:bg-green-900"></div>
        <div ngxproTitle>
          <div class="text-sm font-medium">Small Cell</div>
          <div ngxproSubtitle>40px min height</div>
        </div>
      </div>
      ...
      <div ngxproCell="m" class="border border-gray-200 dark:border-gray-800">
        ...
        <div ngxproTitle>
          ...
          <div ngxproSubtitle>52px min height</div>
        </div>
      </div>

      <div ngxproCell="l" class="border border-gray-200 dark:border-gray-800">
        <div class="w-12 h-12 rounded bg-purple-100 dark:bg-purple-900"></div>
        <div ngxproTitle>
          <div class="text-lg font-medium">Large Cell</div>
          <div ngxproSubtitle>72px min height</div>
        </div>
      </div>
    </div>
  `
  ...
  template: `
    <div class="space-y-6 max-w-md">
      <div ngxproTitle="s">
        ...
        <p ngxproSubtitle>This is a small title with subtitle</p>
      </div>

      <div ngxproTitle="m">
        <h3 class="font-semibold">Medium Title</h3>
        <p ngxproSubtitle>This is a medium title with subtitle</p>
      </div>

      <div ngxproTitle="l">
        <h2 class="font-bold">Large Title</h2>
        <p ngxproSubtitle>This is a large title with more spacing</p>
      </div>

      <div ngxproTitle>
        <h2 class="font-semibold">Default Title</h2>
        <p ngxproSubtitle>No size specified, inherits from parent</p>
      </div>
    </div>
  `
})
      ...
      <div class="divide-y divide-gray-200 dark:divide-gray-800">
        <button ngxproCell="m" class="w-full">
          ...
          <div ngxproTitle class="flex-1">
            ...
            <div ngxproSubtitle>Hey, can we schedule a call?</div>
          </div>
        ...
        <button ngxproCell="m" class="w-full">
          ...
          <div ngxproTitle class="flex-1">
            ...
            <div ngxproSubtitle>Great work on the new design!</div>
          </div>
        ...
        <button ngxproCell="m" class="w-full">
          ...
          <div ngxproTitle class="flex-1">
            ...
            <div ngxproSubtitle>Due in 3 days</div>
          </div>
