 ...
 *
 * @example
 * <span nxpBadge color="violet">Fiction</span>
 *
 * @example
 * <span nxpBadge variant="dot" color="green">Active</span>
 *
 * @example
 * <span nxpBadge size="lg" color="blue">Large</span>
 */
@Directive({
  selector: '[nxpBadge]',
  standalone: true,
...
export class NxpBadgeDirective {
  ...
  readonly hostClasses = computed(() => {
    ...
    return cx(
      ...
      isDot && 'border border-gray-200 dark:border-gray-700/80',
      this.class(),
    );
  });
  ...
  /** Dot size in pixels (for use by the dot element inside the badge). */
