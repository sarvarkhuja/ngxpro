...
import { CALENDAR_OPTIONS } from './calendar.providers';
import type {
  CalendarView,
  DisabledHandler,
  MarkerHandler,
...
@Component({
  ...
  template: `
    <div
      class="inline-flex flex-col gap-0 rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950"
      role="application"
