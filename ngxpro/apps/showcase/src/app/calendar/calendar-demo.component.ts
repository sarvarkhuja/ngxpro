    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div class="max-w-5xl mx-auto space-y-12">
        ...
        <div>
          ...
          <h1 class="mt-4 text-3xl font-bold text-gray-900 dark:text-white">Calendar</h1>
        ...
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-3">
          ...
          <section class="space-y-3">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Single date</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Click any day to select it.</p>
            <nxp-calendar
              [value]="singleValue()"
            ...
            @if (singleValue()) {
              <p class="text-sm text-gray-700 dark:text-gray-300">
                Selected: <strong>{{ singleValue()!.toLocaleDateString() }}</strong>
              </p>
            }
          </section>
          ...
          <section class="space-y-3">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Click start then end date.</p>
            <nxp-calendar
              [rangeMode]="true"
              [value]="rangeValue()"
          ...
          <!-- 3. Disabled weekends -->
          <section class="space-y-3">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Disabled weekends</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Saturdays and Sundays are not selectable.</p>
            <nxp-calendar
              [value]="disabledValue()"
            ...
            @if (disabledValue()) {
              <p class="text-sm text-gray-700 dark:text-gray-300">
                Selected: <strong>{{ disabledValue()!.toLocaleDateString() }}</strong>
              </p>
            }
          </section>
          ...
          <!-- 4. Dot markers -->
          <section class="space-y-3">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Event markers</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Coloured dots highlight dates with events.</p>
            <nxp-calendar
              [value]="markerValue()"
          ...
          <section class="space-y-3">
            ...
            @if (boundedValue()) {
              <p class="text-sm text-gray-700 dark:text-gray-300">
                Selected: <strong>{{ boundedValue()!.toLocaleDateString() }}</strong>
              </p>
            }
          </section>
          ...
          <section class="space-y-3">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Hide adjacent days</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Days outside the current month are hidden.</p>
            <nxp-calendar
              [value]="adjacentValue()"
              [showAdjacent]="false"
...
export class CalendarDemoComponent {
  ...
  readonly markerFn: MarkerHandler = (date: Date): [] | [string] | [string, string] => {
