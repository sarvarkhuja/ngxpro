...
/**
 * Coerce a query-param string back into a typed JS value. Accepts JSON
 * literals (objects, arrays), booleans, numbers, and falls back to the
 * decoded string. Mirrors Taiga's `tuiCoerceValue`.
 */
export function nxpCoerceValue<T>(
  value?: T,
