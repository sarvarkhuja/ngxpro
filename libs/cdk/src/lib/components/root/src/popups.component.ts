...
@Component({
  ...
  styles: [
    `
      ...
      nxp-popups > [data-inline='end'] {
        justify-self: end;
      }
      nxp-popups > [data-inline='center'] {
        justify-self: center;
      }
      nxp-popups > [data-block='end'] {
        align-self: end;
      }

      /* Top stacking: rows 5–9 (rows 1–4 reserved for other portal types) */
      nxp-popups > [data-block='start']:nth-of-type(1) {
        grid-row: 5;
      }
      nxp-popups > [data-block='start']:nth-of-type(2) {
        grid-row: 6;
      }
      nxp-popups > [data-block='start']:nth-of-type(3) {
        grid-row: 7;
      }
      nxp-popups > [data-block='start']:nth-of-type(4) {
        grid-row: 8;
      }
      nxp-popups > [data-block='start']:nth-of-type(5) {
        grid-row: 9;
      }

      /* Bottom stacking: rows 11–15 (overrides the default top rows above) */
      nxp-popups > [data-block='end']:nth-of-type(1) {
        grid-row: 11;
      }
      nxp-popups > [data-block='end']:nth-of-type(2) {
        grid-row: 12;
      }
      nxp-popups > [data-block='end']:nth-of-type(3) {
        grid-row: 13;
      }
      nxp-popups > [data-block='end']:nth-of-type(4) {
        grid-row: 14;
      }
      nxp-popups > [data-block='end']:nth-of-type(5) {
        grid-row: 15;
      }
      ...
      nxp-popups > .nxp-enter[data-block='end'] {
        animation: nxp-slide-in-bottom 400ms cubic-bezier(0.21, 1.02, 0.73, 1)
          both;
      }
      ...
      @keyframes nxp-swipe-out-left {
        from {
          opacity: 1;
          transform: translateX(var(--swipe-amount-x, 0));
        }
        to {
          opacity: 0;
          transform: translateX(calc(var(--swipe-amount-x, 0) - 100%));
        }
      }
