...
@Directive({
  ...
  host: {
    ...
    tabindex: '0',
    class:
      'relative z-10 flex items-center gap-2 w-full px-3 py-2 rounded-s font-medium outline-none cursor-pointer no-underline',
    '[class.text-text-primary]': 'checked()',
    '[class.text-text-secondary]': '!checked()',
