# ngxpro Quick Reference Card

**For AI Agents working on ngxpro**
...
```
@ngxpro/cdk         # Utils (focus, DOM, math, observables, Polymorpheus)
@ngxpro/core        # Services (theme, format, breakpoint)
@ngxpro/components  # Base UI (Accordion, Button, Card, ...)
@ngxpro/blocks      # Composed (charts, tables, forms, ...)
@ngxpro/fintech     # Domain-specific
@ngxpro/cli         # Code generator
```
...
**Package**: `@taiga-ui/polymorpheus` (1KB, included in @ngxpro/cdk)
...
- `.cursor/rules/ngxpro-project-context.mdc` — Mission and package layout
...
**"Taiga architecture + Tremor styling = ngxpro components"**
