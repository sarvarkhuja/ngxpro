...
When working on nxp, **adopt the appropriate agent role**:
...
| File                      | Purpose                                              |
| ------------------------- | ---------------------------------------------------- |
| `NXP_AGENTS.md`           | Complete agent structure, workflows, quality metrics |
...
- **Secondary entry points** (`@nxp/components/accordion`)
...
- [ ] Create @nxp/cdk (Taiga CDK patterns)
- [ ] Create @nxp/core (services, tokens)
- [ ] CI/CD pipeline
...
- [ ] Implement nxp-accordion (combining both)
