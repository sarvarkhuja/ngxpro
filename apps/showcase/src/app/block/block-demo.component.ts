      ...
      <div class="max-w-3xl mx-auto">
        ...
        <section class="mb-12">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Single-choice plan picker with animated active pill.
          </p>
        ...
        <section class="mb-12">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Multi-choice with animated hover and focus tracking.
          </p>
          <nxp-block-group class="max-w-sm">
            <label nxpBlock size="m">
              <input
                type="checkbox"
                nxpCheckbox
                [formControl]="features['notifications']"
              />
              <span class="flex flex-col">
                <span class="font-medium text-gray-900 dark:text-white"
                  >Notifications</span
            ...
            <label nxpBlock size="m">
              <input
                type="checkbox"
                nxpCheckbox
                [formControl]="features['analytics']"
              />
              <span class="flex flex-col">
                <span class="font-medium text-gray-900 dark:text-white"
                  >Analytics</span
        ...
        <section class="mb-12">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Disabled blocks remain visible but non-interactive.
          </p>
          <nxp-block-group class="max-w-sm">
            <label nxpBlock size="m">
              <input
            ...
            <label nxpBlock size="m">
              <input
                type="checkbox"
                nxpCheckbox
                [formControl]="disabledCheckedControl"
              />
              <span class="flex flex-col">
                <span class="font-medium text-gray-900 dark:text-white"
